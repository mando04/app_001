...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('www', ['www'])

        # Adding unique constraint on 'Post', fields ['title']
        db.create_unique('www_post', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Post', fields ['title']
        db.delete_unique('www_post', ['title'])

        # Deleting model 'www'
        db.delete_table('www_www')
    ...
    models = {
        ...
        'www.post': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True', 'auto_now_add': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
